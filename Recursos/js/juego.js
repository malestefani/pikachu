...
function intercambiarPosiciones(filaPos1, columnaPos1, filaPos2, columnaPos2){
	...
	var pieza1=document.getElementById("pieza"+grilla[filaPos1][columnaPos1]);
	var pieza2=document.getElementById("pieza"+grilla[filaPos2][columnaPos2]);
	var padre=pieza1.parentNode;
	var copia1=pieza1.cloneNode(true);
	var copia2=pieza2.cloneNode(true);
	padre.replaceChild(copia1,pieza2);
	padre.replaceChild(copia2,pieza1);
}
